...
{
    public $jabatan_pegawai_id, $pegawai_nama, $team_nama, $jabatan_nama;
    public function render()
    {
        return view('livewire.jabatan-pegawai-update', [
            ...
            'teams' => Unit::whereIn('id', JabatanPegawai::where('id_pegawai', Pegawai::where('id_user', auth()->user()->id)->first()->id)->pluck('id_team'))->get(),
