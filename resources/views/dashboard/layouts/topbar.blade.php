<header id="page-topbar">
        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    ...
                    {{-- <input type="checkbox" class="mode-switcher" id="chk" />
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Halo, {{ Auth::user()->nama_lengkap }}</h6>
    ...
    <script>
        $(document).ready(function() {
            $('#mode-switcher').change(function() {
                if($('#mode-switcher').checked) {
                    $('#mode-switcher').val('light');
                    $('#mode-icon').addClass('bx-moon');
                    $('#mode-icon').removeClass('bx-sun');
                }else{
                    $('#mode-switcher').val('dark');
                    $('#mode-icon').addClass('bx-sun');
                    $('#mode-icon').removeClass('bx-moon');
                }
            });
        });
    </script>
