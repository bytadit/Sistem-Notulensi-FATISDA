                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <span wire:click="setPermission({{ $jabatanPegawai->id }})" class="cursor-pointer">
                                                <a class="btn btn-sm btn-primary edit-item-btn align-middle" data-bs-toggle="tooltip"
                                                   data-bs-placement="right" title="Role & Permission"
                                                   href="{{route('manage-pejabat.permission', ['team' => $jabatanPegawai->id_team, 'pejabat' => $jabatanPegawai->id])}}">
                                                    <i class="mdi mdi-pencil-box-multiple"></i>
                                                    Role &  Permission
                                                </a>
                                            </span>
