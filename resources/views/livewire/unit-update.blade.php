<div wire:ignore.self class="modal fade" id="modalEditUnit" tabindex="-1" aria-labelledby="modalEditUnitLabel" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUnitLabel">Ubah Unit Rapat</h5>
                        ...
                        <div class="col-xxl-6">
                            <div>
                                <select wire:model="unit_isaktif" class="form-select mb-3" aria-label="Select Status Unit" id="unit_isaktif">
                                    <option selected disabled>Pilih Status Unit</option>
